...
#v(-0.5em)
- Relevant Coursework: Discrete Computational Structures, Matrix & Linear Algebra, Quantum Information Processing
#grid(
  columns: (1fr, auto),
...
#v(-1em)
#line(length: 100%, stroke: 0.4pt)
#grid(columns: (1fr, auto), [*Software Engineer — Research*], [August 2025 - Present])
#v(-0.6em)
...
#grid(columns: (1fr, auto), [*Software Engineer*], [March 2026 - Present])
#v(-0.6em)
...
#v(-0.4em)
- Built full-stack telemetry dashboard (Nuxt.js, Electron, ExpressJS, WebSockets) for real-time monitoring of BMS, GPS, and camera feeds.
- Configured Arch Linux ARM on Raspberry Pi 5 with Hyprland compositor and WireGuard VPN, enabling worldwide real-time telemetry monitoring.
...
#v(-0.6em)
*Tools & Frameworks:* Docker, Git, CMake, XMake, NumPy, SciPy, INDI, VirtualBox, VMware, QEMU, Electron, WebSockets, ExpressJS \
#v(-0.6em)
